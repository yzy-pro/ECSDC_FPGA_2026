...
module ipml_sdpram_v1_13_cboard_imu_rx_fifo
  #(
...
reg   [3:0] rd_addr_bsel_rd_ce   ='b0;
reg   [3:0] rd_addr_bsel_rd_oce  ='b0;
reg   [3:0] rd_addr_bsel_rd_invt ='b0;

//CE
always @(posedge rd_clk)
begin
    if ((c_RD_ADDR_STROBE_EN == 1) && (c_RD_CLK_EN == 1)) begin
...
begin
    if ((c_RD_OCE_EN == 1) && (c_RD_CLK_OR_POL_INV == 1)) begin
        if (rd_oce)
