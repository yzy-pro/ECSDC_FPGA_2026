...
static void bmi088_accel_exti_handler(void *context);
static void bmi088_gyro_exti_handler(void *context);
static void ist8310_exti_handler(void *context);
static void ins_task_wakeup_exti_handler(void *context);
...
void INS_task(void const *pvParameters)
{
    ...
    BSP_EXTI_RegisterCallback(INT1_ACCEL_Pin, bmi088_accel_exti_handler, NULL);
    BSP_EXTI_RegisterCallback(INT1_GYRO_Pin, bmi088_gyro_exti_handler, NULL);
    BSP_EXTI_RegisterCallback(DRDY_IST8310_Pin, ist8310_exti_handler, NULL);
    BSP_EXTI_RegisterCallback(GPIO_PIN_0, ins_task_wakeup_exti_handler, NULL);
...
{
    BSP_EXTI_DispatchCallback(GPIO_Pin);
}
